...
;(function (undefined) {
    ...
    SelectHandler.prototype.updateRectSelection = function () {
        ...
        if (this.options.deletePoint) {
            this.rectSelection.set.get(10).center(bbox.width / 2, bbox.height + 16);
        }
    };
    ...
    SelectHandler.prototype.selectRect = function (value) {
        ...
        if (this.options.rotationPoint && !this.rectSelection.set.get(9)) {
            ...
            this.rectSelection.set.add(this.nested.image('/images/rotate.png').center(bbox.width / 2-8, 20-8)
        ...
        if (this.options.deletePoint && !this.rectSelection.set.get(10)) {

            this.rectSelection.set.add(this.nested.image('/images/delete.png').center(bbox.width / 2-8, bbox.height + 8)
                .click(function (ev) {
                    // console.log("del:"+_this.el+":"+_this.parent);
                    ev = ev || window.event;
                    ev.preventDefault ? ev.preventDefault() : ev.returnValue = false;
                    _this.el.fire('del', {x: ev.pageX, y: ev.pageY, event: ev});
                }));
        }
    ...
    SVG.Element.prototype.selectize.defaults = {
        ...
        deletePoint: true,                       // If true, delete point is drawn. Needed for deletion!
